...
function Header() {
  ...
  return (
    <header className="flex h-header-actual w-full justify-between items-center px-4 sm:px-12 border-b-black dark:border-b-gray-200 border-t-0 border-x-0 border-4 bg-[#e1e2e6] dark:bg-neutral-800">
      {/* right header */}
